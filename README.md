...
<h1 align="center">Hardik Raina</h1>
...
```yaml
Languages:
  - Python, Go, Rust, C/C++, JavaScript/TypeScript, SQL, Lua

AI/ML/DL:
  - LLM Fine-tuning & Training, Multimodal AI, RAG, Constrained Generation
  - Genetic Algorithms, Reinforcement Learning, RLHF, PyTorch, Haystack

Domains:
  - Self-Hosted Agentic LLM Workflows, MCP Servers, Generative AI, CV, EDA Tooling
